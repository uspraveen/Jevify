...
This repo holds only what Jevify adds to `Qwen/Qwen3.5-4B`: **2,891,275 parameters** of trained
decision heads (11.6 MB) plus the calibration recipe. The backbone is pulled from its
...
|---|---|---|
| Qwen3.5-4B (Tier 1 residual) — Tier 1 heads | 0.749 / 0.107 | 0.680 / 0.082 |
| Jev 1.13.0 — API (zero-shot) | 0.835 / 0.090 | 0.694 / 0.122 |
| Qwen/Qwen3.5-4B — Tier 0 (recipe refit w/o held-out) | 0.714 / 0.139 | 0.641 / 0.087 |
